...
public class C02_Locators {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        List<WebElement> basliElementleriList = driver.findElements(By.className("headers"));

        int expectedBaslikSayisi = 6;
        int actualBaslikSayisi = basliElementleriList.size();
        ...
        for (WebElement eachBaslik : basliElementleriList) {
